...
cursor = cnxn.cursor()
#course_info
query1 = "SELECT * FROM thuir_studscore_attr WHERE SETYEAR = '108' AND SETTERM = '1' AND type_name= '日間學士班';"
df109_2＿修課 = pd.read_sql(query1, cnxn)
...
df109_2_AI生修課狀況_new = df109_2_AI生修課狀況.drop_duplicates(subset=['STUD_NO', 'CURR_CODE'], keep='first')
...
df109_2_AI生修課狀況_new.to_excel (r'D:\AI_學生效益分析108_2開始\df108_1_學生修課狀況_new_跨域_成績1.xlsx', index = False, header=True)
